...
define("APP_CSS_URL", APP_LIB_URL.'assets/styles/');
define("APP_SCRIPT_URL", APP_LIB_URL.'assets/scripts/');
define("APP_IMG_URL", APP_LIB_URL.'assets/images/');
...
require_once('lib/Trackbacks.php');
